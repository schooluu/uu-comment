  ...
  setup(__props) {
    ...
    const showCityPicker = async () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/comment/add/add-review.vue:289", "城市选择错误:", error);
        common_vendor.index.showToast({
          title: "获取城市列表失败",
          icon: "none"
        });
    ...
    const getCurrentTheme = () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/comment/add/add-review.vue:355", "获取主题失败:", e);
      }
    };
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/comment/add/add-review.js.map
