...
const rules = ref([
  '本课卡适用在FANCYFANCY未有过任何消费记录的用户，消费记录包括充值记录，上课记录，体验课记录，私教及其它特殊课程上课记录。',
  '点击"领取课卡"后，请根据您的需求，从"FANCYFANCY上海单次体验卡""FANCYFANCY南京单次体验卡""FANCYFANCY成都单次体验卡"中选择其一进行领取，领取后可进行约课。',
  'FANCYFANCY南京单次体验卡"FANCYFANCY成都单次体验卡"分别适用于南京/成都门店，与上海门店不通用。可点击小程序"FANCYFANCY"进入约课界面，点击筛选按钮选择对应门店后，进行约课。',
